  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        Are you sure you want to delete {{modelBody}}?
      </div>
...
export default{
    ...
    methods: {
        ModalToggle(){
            this.modalToggle = this.modalToggle = 'hide' ? 'open' : 'hide'
        },
        openModal(id, name){
            this.userId = id;
            this.modelBody = name;
